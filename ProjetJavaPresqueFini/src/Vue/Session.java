...
public  Session (String login, String mdp){
    ...
    if (rst != null) 
    {
          ...
          if (size==1){
             ...
             switch(droit)
             {
                 case(1):nomdroit="Administrateur";break;
                 case(2):nomdroit="Référent pédagogique";break;
                 case(3):nomdroit="Enseignant";break;
                 case(4):nomdroit="Etudiant";break;                 
             }
             
             jop1.showMessageDialog(null, "Connexion réussie ! Vous êtes un "+nomdroit, "Information", JOptionPane.INFORMATION_MESSAGE);
             //new RoomTable(query);
